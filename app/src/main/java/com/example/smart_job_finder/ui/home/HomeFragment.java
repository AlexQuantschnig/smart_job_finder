...
public class HomeFragment extends Fragment {
    ...
    static {
        ...
        itemList.add(new ListItem(R.drawable.linkedin, "Marketing and Management", "A LinkedIn Marketing and Management Specialist is responsible for optimizing LinkedIn profiles, developing content strategies, engaging with professional networks, managing advertising campaigns, and monitoring analytics to enhance brand visibility and professional networking. ", R.drawable.ic_heart));
        itemList.add(new ListItem(R.drawable.netflix, "Project Manager", "A Netflix Project Manager is responsible for overseeing and managing various projects within the company, ensuring they are completed on time and within budget. They coordinate cross-functional teams, set project goals, and deliver high-quality content or technical solutions for the streaming platform. ", R.drawable.ic_heart));
        itemList.add(new ListItem(R.drawable.x_logo, "Customer Service", "A Twitter Customer Service Representative is responsible for providing assistance and support to Twitter users, addressing their inquiries, issues, and concerns. They engage with users through various communication channels to ensure a positive experience, resolve problems, and uphold the platform's policies and standards. ", R.drawable.ic_heart));
    }
