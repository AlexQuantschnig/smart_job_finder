...
public class HomeFragment extends Fragment {
    ...
    static {
        ...
        itemList.add(new ListItem(R.drawable.netflix, "Project Manager", "A Netflix Project Manager is responsible for overseeing and managing various projects within the company, ensuring they are completed on time and within budget. They coordinate cross-functional teams, set project goals, and deliver high-quality content or technical solutions for the streaming platform. ","Graz", R.drawable.ic_heart));
